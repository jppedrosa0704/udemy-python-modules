...
Criação, remoção e navegação entre pastas
...
🎯 Objetivo da seção
Ao concluir esta seção, o aluno será capaz de:

Trabalhar com arquivos e diretórios

Manipular datas e horários de forma simples e avançada

Automatizar tarefas no sistema operacional

Ler e escrever dados estruturados (JSON e CSV)

Criar automações web com Selenium

Processar imagens com Pillow

Integrar múltiplos módulos em projetos reais
